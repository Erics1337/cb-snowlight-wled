...
- Milestone 1 is implemented in `cb_snowlight.cpp`: the usermod is renamed, config fields are present, example-only code is removed, and runtime status is exposed.
