...
function main() {
  ...
  const nodeChecks = [
    ...
    'tests/write_firmware_manifest.js --out /tmp/cb-snowlight-local-checks/firmware-manifest.json',
    'tests/validate_firmware_manifest.js --manifest /tmp/cb-snowlight-local-checks/firmware-manifest.json',
    'tests/package_hardware_artifacts.js --out /tmp/cb-snowlight-local-checks/hardware-bundle --force',
    'tests/validate_hardware_bundle.js --bundle /tmp/cb-snowlight-local-checks/hardware-bundle',
